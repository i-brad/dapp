...
const MySwiperComponent = () => {
    return (
        ...
        >
            <SwiperSlide>
                <div
                    className="h-full px-4 md:px-12 lg:px-24 rounded-lg"
                    style={{
                    ...
                    <div className="h-full flex flex-col items-start justify-center">
                        <div className="space-y-2 z-10">
                            <h1 className="font-semibold text-3xl text-white">
                                Fair Token Launchpad and Token Management Protocol
                            </h1>
                            <p className="text-white font-lg">
                                Thrustpad allows projects organize raise for initial Liquidity,
                                setup staking, create locks and launch token in one place.
                            </p>
                        </div>
                        <div className="relative mt-8 flex flex-col items-start justify-start gap-2">
                            <div className="flex items-center justify-between text-base z-10">
                                <Link
                                    className="bg-[#DA5921] border border-[#DA5921] text-[#fff] px-5 py-3 text-base rounded-lg"
                                ...
                                <div className="flex items-center">
                                    <Link
                                        ...
                                        className="inline-block w-auto px-2 py-2.5 font-semibold"
                                    >
            ...
            <SwiperSlide>
                ...
                >
                    <div className="h-full flex flex-col items-start justify-center">
                        <div className="space-y-2 z-10">
                            <h1 className="font-semibold text-3xl text-white">
                                Fair Token Launchpad and Token Management Protocol2
                            </h1>
                            <p className="text-white font-lg">
                                Thrustpad allows projects organize raise for initial Liquidity,
                                setup staking, create locks and launch token in one place.

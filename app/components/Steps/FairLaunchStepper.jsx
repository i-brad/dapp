    ...
    return (
        ...
        <div ref={stepperRef}>
                                ...
                                <div className='flex w-full gap-5 items-center flex-wrap lg:flex-nowrap'>
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Token you will raise the liquidity and funding in</p>
                                        </div>
                                        <input
                                            type="text"
                                ...
                                <div className='flex w-full gap-5 items-center flex-wrap lg:flex-nowrap'>
                                    ...
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Total amount of token to sell to buyers (not liquidity tokens)</p>
                                            <p className='text-white text-right text-xs'>Available balance: <span>300,000</span></p>
                                        </div>
                                ...
                                <div className='flex w-full gap-5 items-center flex-wrap lg:flex-nowrap'>
                                    ...
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Minimum amount of funds raised. It needs to be 10% of Hard cap</p>
                                        </div>
                                    ...
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Maximum amount that can be bought</p>
                                        </div>
                                ...
                                <div className='flex w-full gap-5 items-center flex-wrap lg:flex-nowrap'>
                                    ...
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Additional tokens required for liquidity is hard cap is reached</p>
                                        </div>
                                                ...
                                                <div>
                                                    <h3 className='text-[22px] font-medium text-white inline-flex items-center gap-2'>
                                                        <div className='flex items-center'>
                                                            ...
                                                            20
                                                            <span className='text-[#BEBDBD]  text-sm'> EDU</span>
                                                        </div>
                                    ...
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Amount changes based on max allocation per user</p>
                                        </div>
                                        ...
                                        <div className='flex flex-col gap-1 mt-1'>
                                            ...
                                            <div className='inline-flex items-center gap-3'>
                                                <p className='text-[#B7B1AE] text-xs'><span className=' text-white'>0</span> UNCL spots</p>
                                                <p className='text-[#B7B1AE] text-xs'><span className=' text-white'>200</span> whitelist spots</p>
                                            </div>
                                ...
                                <div className='flex w-full gap-5 items-center flex-wrap lg:flex-nowrap'>
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>This is gotten by dividing hard cap from the total token up for sale</p>
                                        </div>
                                        <input
                                            type="text"
                                            id="presale_rate"
                                    ...
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>This is the percent of presale rate you want to list</p>
                                        </div>
                                        <input
                                            type="text"
                                            id="listing_rate"
                                ...
                                <div className='flex w-full gap-5 items-center flex-wrap lg:flex-nowrap'>
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Date to begin fair launch sale</p>
                                        </div>
                                        <input
                                            type="date"
                                            id="start_date"
                                ...
                                <div className='flex w-full gap-5 items-center flex-wrap lg:flex-nowrap'>
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Estimated period where liquidity would be locked</p>
                                        </div>
                                        <select 
                                            defaultValue={1}
                                    ...
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        <div className='mb-1'>
                                            ...
                                            <p className='text-[#898582] text-xs'>Select your country of operation. Where is your business headquartered</p>
                                        </div>
                                        <select 
                                            defaultValue={null}
                                            id="liquidity_lock_period"
                                    ...
                                    <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                        ...
                                        <label 
                                            ...
                                            <input
                                                ...
                                                required
                                                autoComplete="off"
                                                onChange={()=>{setSaleVesting(!saleVesting)}}
                                            />
                                            <div className='mb-1'>
                                                <h4
                                                    className="text-sm text-[#FFFCFB] mb-1"
                                                ...
                                                <p className='text-[#898582] text-xs'>Add vesting for sale contributors</p>
                                            </div>
                                        </label>
                                            ...
                                            <div className='flex w-full gap-5 items-center flex-wrap lg:flex-nowrap'>
                                                <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                                        <label
                                                            ...
                                                            className="text-sm text-[#FFFCFB] mb-1"
                                                        >
                                                            Token release on launch <span className='text-[#898582]'>(%)</span> 
                                                        </label>
                                                    <input
                                                        type="number"
                                                ...
                                                <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                                    <label
                                                        ...
                                                        className="text-sm text-[#FFFCFB] mb-1"
                                                    >
                                                        Cliff <span className='text-[#898582]'>(Extra delay in days before first vesting cycle)</span>
                                                    </label>
                                                    <input
                                                        type="number"
                                                        id="cliff"
                                                ...
                                                <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                                    <div className='mb-1'>
                                                        <label
                                                            ...
                                                            className="text-sm text-[#FFFCFB] mb-1"
                                                        >
                                                            Token release per vesting cycle  <span className='text-[#898582]'>(%)</span> 
                                                        </label>
                                                    </div>
                                                    <input
                                                        type="number"
                                                ...
                                                <div className="mb-6 flex flex-col gap-1 relative w-full lg:w-1/2">
                                                    <div className='mb-1'>
                                                        <label
                                                            ...
                                                            className="text-sm text-[#FFFCFB] mb-1"
                                                        >
                                                            Vesting period each cycle <span className='text-[#898582]'>(days)</span>
                                                        </label>
                                                    </div>
                                                    <input
                                                        type="number"
            ...
            <Box mt={4}>
                ...
                <div className='mt-4'>
                    <p className='font-medium text-[#878483] text-center text-sm'>You will be charged $500 worth of DENNIE token to create this sale</p>
                </div>

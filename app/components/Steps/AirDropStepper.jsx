                                        ...
                                        <div className="text-[#AFACAB] space-y-4">
                                            <div className="space-y-1">
                                                <p className="text-sm">
                                                    ...
                                                    columns match our{" "}
                                                    <Link href={"/"} className="text-[#FFA178]">
                                                        template document
                                                    </Link>
                                                    , to add recipients.
                                                </p>
                                                <p className="text-sm">
                                                    You can upload numerous CSV files to use as
                                            ...
                                            <div>
                                                <p className="text-sm">
                                                    There is a 150,000 recipient cap.{" "}
                                                    <Link href={"/"} className="text-[#FFA178]">
                                                        Schedule a call
                                                    </Link>{" "}
                                                    to speak with us so we can use our CLI tool for
                                                    greater airdrops.
                                                </p>
                                            </div>
                                        </div>

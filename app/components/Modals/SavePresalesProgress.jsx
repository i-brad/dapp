        ...
        <>
            ...
            />
                <ModalContent className='bg-[#303030] text-white min-h-[400px] py-[25px] px-6 rounded-2xl'>
                    <ModalHeader className='text-center py-3 border-b border-[#414040]'>Creating Presale</ModalHeader>
                    <ModalBody>
                        <div className='px-5 py-4'>
                            <div className="flex items-center h-full w-full justify-center py-12 text-center flex-col">
                                ...
                                <p className="text-xl text-[#898582] mt-3 font-medium ">Approve spending 500,000 Forge</p>

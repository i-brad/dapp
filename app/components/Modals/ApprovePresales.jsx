    ...
    <>
      <Modal isOpen={isOpen} onClose={onClose} isCentered size="4xl">
        ...
        <ModalContent className="bg-[#303030] text-white min-h-[500px] py-[25px] rounded-2xl">
          ...
          <ModalBody>
            <div className="py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 px-2 w-full gap-3">
                <div className="bg-[#414040] rounded-lg flex flex-col text-white py-[14px] px-4 group min-h-[250px] max-h-[300px] justify-between">
                  <div className="flex items-center justify-start w-full">
                    <div className="w-16 h-16 relative overflow-hidden featured__card_img block object-contain rounded-full">
                      <Image
                        src={
                          "/images/stairs-abstract-geometric-shapes-background.svg"
                        }
                        fill
                        alt={"fall-back"}
                  ...
                  <div className="text-[#F08454] text-base font-medium">
                    <h3 className="text-sm text-[#DCDCDC] inline-flex items-center gap-2">
                      Fee{" "}
                      <span className="text-[#F08454] font-semibold text-xl">
                        100 EDU
                      </span>
                    </h3>
                  </div>
                ...
                <div className="bg-[#414040] opacity-50 rounded-lg flex flex-col text-white py-[14px] px-4 group min-h-[250px] max-h-[300px] justify-between">
                  <div className="flex items-center justify-start w-full">
                  ...
                  <div className="py-2 w-full  gap-1 space-y-2 min-h-24">
                    ...
                    <div>
                      <ul className=" list-inside list-disc text-[#F0EDED] text-sm">
                        <li>Telegram Channel Annoucement</li>
                        <li>Audit Badge</li>
                        <li>KYC Badge</li>
                      </ul>
                    </div>
                  ...
                  <div className="py-2 w-full  gap-1 space-y-2 min-h-24">
                    ...
                    <div className="flex justify-start gap-3">
                      <ul className=" list-inside list-disc text-[#F0EDED] text-sm">
                        <li>Audit Badge</li>
                        <li>KYC Badge</li>
                        <li>Telegram Buybot</li>
                      </ul>
                      <ul className=" list-inside list-disc text-[#F0EDED] text-sm">
                        <li>Featured Banner Ads</li>
                        <li>Annoucement on all Socials</li>
                      </ul>
                    </div>
                  </div>
                  <div className="text-[#F08454] text-base font-medium">
              ...
              <div className="flex items-center justify-center w-full mt-4">
                <button
                  type="button"
                  onClick={handleCloseSelectPlan}
                  className="bg-[#DA5921] hover:bg-[#DA5921] min-w-[200px] w-full md:max-w-[250px] whitespace-nowrap 

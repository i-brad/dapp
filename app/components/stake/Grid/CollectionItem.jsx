            ...
            >
                <div className="flex flex-col gap-4 justify-between h-full ">
                    ...
                    <div className="flex items-center justify-between font-medium flex-wrap gap-2">
                        <p className="text-xs text-[#ADB4B9]">
                            ...
                            <span className="text-sm text-[#FFA178] ml-1">
                                {data?.stake_rate?.toLocaleString()} {data?.token_symbol} - 1 EDU
                            </span>
                        </p>
                        <p className="text-xs text-[#ADB4B9]">
                            Hard cap{" "}
                    ...
                    <div className="font-medium space-y-1">
                        <p className="text-xs text-[#ADB4B9]">Progress ({progress?.toFixed(2)}%)</p>
                        <Progress
                            colorScheme="orange"
                            size="sm"
                            value={progress}
                    ...
                    <div className="flex items-end justify-between flex-wrap w-full">
                        ...
                        <div className="flex">
                            <div>
                                <p className="text-xs text-[#ADB4B9] text-right">Staking ends in:</p>

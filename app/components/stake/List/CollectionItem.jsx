...
const CollectionItem = () => {
  return (
    <>
        <Link href={'/stake/1'} className='bg-[#272727] min-h-[150px] p-5 rounded-lg font-medium relative hover:translate-y-[-20px] transition-all duration-300 ease-linear'>
            <div className='flex flex-col gap-4 justify-between h-full '>
                    ...
                    <div>
                        <div className='flex items-center justify-between font-medium flex-wrap gap-4'>
                            <div>
                                ...
                                <span className='text-sm text-[#FFA178]'>300 EDU</span>
                            </div>
                            <div>
                                <p className='text-xs text-[#ADB4B9]'>Hard cap</p>
                                <span className='text-sm text-[#FFA178]'>1,256 EDU</span>
                            </div>
                            <div>
                                <p className='text-xs text-[#ADB4B9]'>Liquidity</p>
                                <span className='text-sm text-[#FFA178]'>10%</span>
                            </div>
                            <div>
                ...
                <div className='flex items-center justify-between flex-wrap  flex-col-reverse md:flex-row w-full pt-4 border-t border-[#3C3E3E] gap-2'>
                    ...
                    <div className='flex items-center flex-1 justify-end md:justify-normal w-full'>
                        <div>
                            <p className='text-xs text-[#ADB4B9] text-right md:text-left'>Sale ends in:</p>

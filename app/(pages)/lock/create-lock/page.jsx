...
const CreateLock = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const now = new Date();
        const timeInSeconds = Math.floor((lock_date.getTime() - now.getTime()) / 1000);
        ...
        try {
            ...
            const byteCode = await factory.getBytecode(tokenAddress, timeInSeconds, amount);
            ...
            const response = await factory.newLock(tokenAddress, timeInSeconds, amount);
                ...
                <form onSubmit={handleSubmit}>
                    <div className="bg-[#272727] px-5 py-4 rounded-lg">
                        <div className="flex flex-col gap-12 py-4">
                            {/* Token Info */}
                            <div>
                                <h4 className="mb-4 text-lg font-medium text-white">Token Info</h4>
                    ...
                    {isConnected ? (
                        ...
                        <div className="relative flex items-center max-w-[200px] mx-auto justify-center z-[999] ">
                            <ConnectWallet>
                                <PrimaryButton text="Connect wallet" as="span" className="w-fit" />
                            </ConnectWallet>
                        </div>
                    )}
                </form>

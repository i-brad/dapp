...
import AllStake from "./_components/AllStake";
...
const Stake = () => {
  ...
  return (
    <>
            ...
            <div className="flex items-center gap-2 w-full">
              <div className="flex items-center gap-2">
                <button
                  className={`${
                    viewType === 0
                      ? "bg-[#303132] text-[#EA6A32]"
                      : "bg-[#272727] text-white"
                  } hover:bg-[#303132] hover:text-[#EA6A32] p-2 rounded`}
              ...
              <div className=" relative rounded-full  items-center w-full max-w-[563px] h-10 ">
                ...
                <input
                  ...
                  name="search"
                  id="search"
                  className="border border-[#3B3939] py-2 px-4  bstake w-full pl-12 pr-12 sm:text-sm rounded-full h-full focus:outline-none bg-transparent text-white"
                  placeholder="Search"
                />
              </div>
            </div>
      ...
      <CreateLaunchPad isOpen={createPadIsOpen} onClose={onCreatePadClose} />
    </>
  );
};
